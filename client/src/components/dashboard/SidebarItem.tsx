...
function PlaybookItem({ item, isActive, onClick, tickerSymbol, index = 0 }: PlaybookItemProps) {
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <motion.button
              ...
              className={cn(
                "w-full text-left px-2.5 py-2.5 rounded-lg transition-colors group gpu-accelerated",
                isActive
...
function ChatSessionItem({ item, isActive, onClick, index = 0 }: ChatSessionItemProps) {
  return (
    <motion.div
      variants={sidebarItemVariants}
      initial="hidden"
    ...
    >
      <motion.button
        ...
        className={cn(
          "w-full text-left px-2.5 py-1.5 rounded-lg text-sm transition-colors group min-h-[36px] md:min-h-0 gpu-accelerated",
          isActive
...
function ConsolidatedChatItem({ sessions, dayLabel, activeSessionId, onSelectSession, index = 0 }: ConsolidatedChatProps) {
